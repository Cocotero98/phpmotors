	...
	elseif(isset($invMake) && isset($invModel)) { 
		echo "Modify $invMake $invModel"; }?></h1>
            ...
            <label for="invImage">Image path:
                <input type="text" id="invImage" name="invImage" value="/phpmotors/images/vehicles/no-image.png" <?php if(isset($invImage)){echo "value='$invImage'";} elseif(isset($invInfo['invImage'])) {echo "value='$invInfo[invImage]'"; } ?> required>
            </label>
            <label for="invThumbnail">Thumbnail path:
                <input type="text" id="invThumbnail" name="invThumbnail" value="/phpmotors/images/vehicles/no-image.png" <?php if(isset($invThumbnail)){echo "value='$invThumbnail'";} elseif(isset($invInfo['invThumbnail'])) {echo "value='$invInfo[invThumbnail]'"; } ?> required>
            </label>
